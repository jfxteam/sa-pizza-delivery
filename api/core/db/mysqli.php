...
class MySQLiControl extends MySQLi {
	public $table_prefix = '';

	public function __construct($db_host = Config::db_host, $db_user = Config::db_user, $db_pass = Config::db_pass, $db_name = Config::db_name){
